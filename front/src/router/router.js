...
export const otherRouter = {
    ...
    children: [
        ...
        // 工作流相关
        { path: 'myTodo', title: '我的待办', name: 'my_todo', component: () => import('@/views/workflow/myTodo.vue') },
        { path: 'myUndone', title: '我的未办', name: 'my_undone', component: () => import('@/views/workflow/myUndone.vue') },
        { path: 'myProcessed', title: '我的经办', name: 'my_processed', component: () => import('@/views/workflow/myProcessed.vue') }
    ]
};

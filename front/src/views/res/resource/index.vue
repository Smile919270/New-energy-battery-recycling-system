            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="电池名称" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="type">
                        <Select v-model="searchForm.type" clearable placeholder="电池分类" style="width:120px">
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getResourceList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {

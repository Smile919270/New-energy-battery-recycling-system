            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="回收机构名称" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="address">
                        <Input type="text" v-model="searchForm.address" placeholder="机构地址" clearable style="width: 120px" />
                    </Form-item>
...
<script>
import {
    getResourceOrganizationList,
    deleteResourceOrganization
} from "./api.js";
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getResourceOrganizationList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {

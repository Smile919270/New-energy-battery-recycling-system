            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="name">
                        <Input type="text" v-model="searchForm.name" placeholder="接待人姓名" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="mobile">
                        <Input type="text" v-model="searchForm.mobile" placeholder="接待人手机" clearable style="width: 120px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getReceptionistList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {

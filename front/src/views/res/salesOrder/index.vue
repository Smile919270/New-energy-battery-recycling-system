        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="resName">
                        <Input type="text" v-model="searchForm.resName" placeholder="电池名称" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="releaseName">
                        <Input type="text" v-model="searchForm.releaseName" placeholder="发布人姓名" clearable style="width: 120px" />
                    </Form-item>
...
export default {
                            ...
                            h(
                                "Button", {
                                    props: {
                                        ...
                                        icon: "ios-settings",
                                        ghost: true,
                                        disabled: params.row.status > 0 || !(that.$route.meta.permTypes && that.$route.meta.permTypes.includes("enable"))
                                    },
                                    style: {
                                        marginRight: "5px"
                                    },
                                    on: {
                                        click: () => {
                                            this.sellSalesOrderFx(params.row);
                                        }
                                    }
                                }
                            ),
                            h(
                                "Button", {
                                    props: {
                                        ...
                                        ghost: true,
                                        disabled: params.row.status > 0 || !(that.$route.meta.permTypes && that.$route.meta.permTypes.includes("edit"))
                                    },
                                    style: {
                                        marginRight: "5px"
                                    },
                            ...
                            h(
                                "Button", {
                                    props: {
                                        ...
                                        icon: "md-trash",
                                        ghost: true,
                                        disabled: params.row.status > 0 || !(that.$route.meta.permTypes && that.$route.meta.permTypes.includes("delete"))
                                    },
                                    on: {
                                        click: () => {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getSalesOrderList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {

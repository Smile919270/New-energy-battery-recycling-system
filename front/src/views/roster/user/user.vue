        ...
        return {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: (h, params) => {
                        const typeMap = {
                            1: { text: "管理员", color: "#ff9900" },
                            2: { text: "电池出售方", color: "#19be6b" },
                            3: { text: "电池买入方", color: "#2d8cf0" },
                            4: { text: "客服人员", color: "#8a6fe3" }
                        };
                        const currentType = typeMap[params.row.type] || { text: "未知", color: "#ed4014" };
                        return h("div", {
                            style: {
                                display: "flex",
                            ...
                            h(
                                "Button", {
                                    props: {
                                        ...
                                        icon: (params.row.status == 0 ? "md-close" : "md-checkmark")
                                    },
                                    style: {
                                        marginRight: "5px"
                                    },

package cn.zyc.basics.security.controller;
...
import cn.zyc.basics.security.SecurityUserDetails;
import cn.zyc.basics.security.utils.WeiChatUtils;
import cn.zyc.basics.security.utils.ZwzWxNoticeUtils;
import cn.zyc.basics.utils.CommonUtil;
...
@RequestMapping("/zyc/qwVerificationCode")
@Transactional
public class QwVerificationCodeController {
    ...
    public Result<Object> sendVerificationCode(@RequestParam String jobNumber) {
        if(!Objects.equals("zyc",jobNumber)) {
         ...
         * 这里需要实现判断发给谁的业务逻辑
         */
        ZwzWxNoticeUtils.sendTuWenMessage("zyc", "OA登录验证","验证码 " + verificationCode + "，1分钟后失效","https://gitee.com/yyzwz","https://bkimg.cdn.bcebos.com/pic/37d12f2eb9389b503a80d4b38b35e5dde6116ed7", WeiChatUtils.getToken());
